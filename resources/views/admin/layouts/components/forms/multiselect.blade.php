...
<div x-data="dropdown()" x-init="loadOptions()" class="flex flex-col w-full mx-auto">
  ...
  <input name="{{ $name }}" type="hidden" x-bind:value="selectedValues()" style="width: 100%">
  <div class="relative inline-block w-100">
        ...
        <div class="flex p-1 my-2 bg-white border border-gray-200 rounded">
          <div class="flex flex-wrap flex-auto">
            ...
            <div x-show="selected.length == 0" class="flex-1">
              <input placeholder="Selecione uma opção" class="w-full h-full p-1 px-2 text-gray-800 bg-transparent outline-none appearance-none" x-bind:value="selectedValues()">
            </div>
          </div>
	...
	" />
      ...
      <div class="w-full px-4">
        <div x-show.transition.origin.top="isOpen()" class="absolute left-0 z-40 w-full bg-white rounded shadow top-100" style="overflow-y: auto; max-height: 200px;" x-on:click.away="close">
